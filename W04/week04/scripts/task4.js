...
const myInfo = {
    name: 'Israel Carmona',
    photo: 'images/me-modified.png',
    favoriteFoods: ['Pizza', 'Spagetti', 'Tacos', 'Gnoshi'],
    hobbies: ['Code', 'Play the Guitar', 'Play Soccer', 'Read'],
...
myInfo.favoriteFoods.forEach((favoriteFoods) => {
    const favFood = document.createElement('li');
    favFood.textContent = favoriteFoods;
...
myInfo.hobbies.forEach((hobbies) => {
    const hobbiesFav = document.createElement('li');
    hobbiesFav.textContent = hobbies;
    document.querySelector('#hobbies').appendChild(hobbiesFav);
...
myInfo.placesLived.forEach((placesLived) => {
    const placesLivedPlace = document.createElement('dt');
    placesLivedPlace.textContent = placesLived.place;

    const placesLivedLength = document.createElement('dd');
